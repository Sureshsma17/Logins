...
namespace Logins
{
    public partial class ExperiencedITJobApplication : System.Web.UI.Page
    {
        ...
        {
            lblSubmit.Text = "First Name : " + txtFirstName.Text + "<br>" +
                            ...
                            "Post Graduation: " + lblPostGrad.Text + "<br>" + "<br>" +
                            ...
                            "Company Name : " + txtCompany.Text + "<br>" +
                            "Company Name : " + txtCompany.Text + "<br>" +
                              "Company Address : " + txtCompanyAddress.Text + "<br>" +
                              "Company Phone Number : " + txtCompanyPhoneNumber.Text + "<br>" +
                              "Company Website : " + txtCompanyWebsite.Text + "<br>" +
                              "Designation : " + txtDesignation.Text + "<br>" +
                              "Roles and Responsibilities : " + txtRolesandResponsibilities.Text + "<br>" +
                              "Current CTC : " + txtCurrentCTC.Text;
